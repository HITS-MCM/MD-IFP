...
class  Ligand:
    ...
    def __init__(self,PRJ_DIR,ligand_pdb,ligand_mol2="moe.mol2"):
            ...
            if ligand_pdb or ligand_mol2:                   
                ...
                try:    
                    ...
                    if DO_PDB:
                        print("RDKit cannot read PDB structure, atom naming will be corrected")
 ...
 #                   print("Fluorine atoms found: ",list_labelsF)
                    ...
                    print("PDB file is absent,properties of fluorine atoms (if there are some) will not be treated correctly ")
...
###############################################################################
#
#   FYNCTION that renames hydrogen atoms in a ligand file generated by openbabel (openbabel generats all hydrogen as H)
#   remove connectivity lines
#   adjust position of hydrogen atom names so that H always occupies 14th position (requiered by Rdkit)
#
###############################################################################
